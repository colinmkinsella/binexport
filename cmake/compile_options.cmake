...
elseif(MSVC)  # Visual Studio
  add_compile_options(
    /wd4005  # _CRT_SECURE_NO_WARNINGS previously declared on the command line (binaryninja-api)
    /wd4018  # signed/unsigned mismatch
    /wd4047  # differs in levels of indirection from 'void *' (protobuf)
    /wd4116  # unnamed type definition in parentheses (protobuf)
    /wd4141  # 'inline': used more than once (protobuf)
    /wd4244  # 'argument' conversion, possible loss of data
    /wd4267  # 'initializing' conversion, possible loss of data
    /wd4715  # not all control paths return a value (protobuf)
    /wd5287  # operands are different enum types from protobuf
  )
